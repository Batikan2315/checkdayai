...
export default function PlansPage() {
  ...
  const getCreatorInfo = (creator: any): Creator | undefined => {
    if (!creator) {
      console.log("Creator yok:", creator);
      return {
        _id: "unknown",
        username: 'Anonim',
    ...
    if (typeof creator === 'string') {
      console.log("Creator string:", creator);
      return {
        _id: creator,
        username: 'Kullanıcı',
        profilePicture: '/images/avatars/default.png'
    ...
    if (typeof creator === 'object') {
      ...
      if (creator._bsontype === 'ObjectID') {
        console.log("Creator ObjectId:", creator);
        return {
      ...
      console.log("Creator nesne:", creator);
    ...
    console.log("Bilinmeyen creator formatı:", creator);
    return {
      _id: "unknown",
      username: 'Kullanıcı',
      profilePicture: '/images/avatars/default.png'
